...
const MODEL_PATH = path.join(__dirname, 'racedata/14feat', 'horse_race_predictor_expanded.onnx');
const SCALER_DATA_PATH = path.join(__dirname, 'racedata/14feat', 'scaler_data.json');
const TRACK_MAP_PATH = path.join(__dirname, 'racedata/14feat', 'scaler_track_map.json');
